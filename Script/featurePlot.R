...
meanFeatureScore <- aggregate(cbind(accuracy, f.score)~sample+dim+method, data=dataset, FUN = mean)
...
if(method == 0){
  ...
  print(paste0("Image Filename: featureF1score_", genre, "_", score.num,"_gbm"))
  print(accuracyPlot)
  ...
  print(paste0("Image Filename: featureF1score_", genre, "_", score.num,"_svm"))
  print(accuracyPlot)
}
